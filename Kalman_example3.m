...
%реальный сигнал
file_signal = fopen('new_signal_1000.txt', 'r');
formatSpec = '%f';
...
Rpr = [0.04 0 0 0; 0 0.04 0 0; 0 0 0.0001 0; 0 0 0 0.0001]; %подобрать дисперсию для последнего пар-ра
